...
function init(){
    ...
    var st = new $jit.ST({
        ...
        Node: {
            height: 20,
            width: 150, //To do: use a const for both this and html element width
            //use a custom
        ...
        onCreateLabel: function(label, node){
			...
			label.innerHTML = '<a href="#" onclick="return test()" ><img src="images/button.png" alt="OK"/></a>' +node.name;
